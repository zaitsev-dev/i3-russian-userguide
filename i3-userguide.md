...
### 4.2 <span name="fonts">Шрифты</span>
...
### 4.5. <span name="binding_modes">Режимы привязки</span>
...
Задать шрифт, который будет использоваться в панели можно способом, описанным ниже. См. [Шрифты](#fonts). (FIXME: якорь не ссылается на раздел)
...
The setting also applies to the current binding mode indicator. (FIXME)
...
Как и в i3, цвета находятся в шестнадцатиричном формате HTML (#rrggbb). На данный момент можно настроить следующие цвета:
