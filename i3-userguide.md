...
* `workspace` - cравнивает имя рабочей области, к которой принадлежит окно. Используйте специальное значение `__focused__` для сравнения всех окон в текущей фокусировке рабочей области.
